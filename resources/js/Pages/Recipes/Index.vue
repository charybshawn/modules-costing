    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="md:flex md:items-center md:justify-between mb-6">
        ...
        <div class="mt-4 md:mt-0 flex flex-wrap gap-2">
          ...
          <Link :href="route('admin.costing.production-planner.index')" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            Production Planner
          </Link>
