  ...
  <div>
    ...
    >
      ...
      <template #mobile-actions>
        <IconButton label="View ingredient" :class="iconActionClass" @click="shellRef?.guardNavigation(showUrl())">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const showUrl = () => route('admin.costing.ingredients.show', props.ingredient.id)
